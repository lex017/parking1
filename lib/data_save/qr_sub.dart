...
import 'package:parking1/data_save/pay_sub.dart';

class QrSub extends StatefulWidget {
  final String name;
  ...
  @override
  State<QrSub> createState() => _QrPayState();
}

class _QrPayState extends State<QrSub> {
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (c) => PaySub(
                        ...
                        packageType: widget.packageType, parkingId: widget.parkingId, 
