...
Widget build(BuildContext context) {
  return Scaffold(
    ...
    body: StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        final locationId = userData['location_id'] ?? 'N/A';
 ...
 Widget _buildProfileSection(String profileImage, String firstName, String lastName,String locationId) {
  return Card(
    color: Colors.white,
    shape: RoundedRectangleBorder(
      borderRadius: BorderRadius.circular(15),
      side: BorderSide(color: Colors.blueAccent, width: 2), // Border around the card
    ),
    elevation: 5,
    child: Padding(
    ...
    children: [
      SizedBox(
        ...
        child: ElevatedButton.icon(
          ...
          icon: const Icon(Icons.qr_code_scanner, size: 30, color: Colors.white), // Added icon
          label: const Text(
            "Scan Ticket",
